...
Product projectFromJson(String str) => Product.fromJson(json.decode(str));
String projectToJson(Product data) => json.encode(data.toJson());
class Product {
  Product({
...
Product copyWith({  List<Products>? products,
  ...
  num? skip,
  num? limit,
}) => Product(  products: products ?? _products,
  total: total ?? _total,
  skip: skip ?? _skip,
  limit: limit ?? _limit,
);
